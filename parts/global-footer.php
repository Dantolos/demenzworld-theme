...
if ( ! class_exists( 'Toplevel_Navbar' ) ) {
     class Global_Footer { 
          public $footer_Navigation_Section;
          ...
          public function footer_call_to_action() {
               $footer_cta = '';
               $footer_cta .= '<div class="dw__footer_call_to_action">';
                    ...
                    $footer_cta .= '<button onclick="openLightBox(\'.dw__newsletter_lightbox_container\')">Einmalige Spende</button>';
               $footer_cta .= '</div>';
               return $footer_cta;
          }

          public function navigation_block() { 
               $footer_nav = '';
          ...
          private function navbar_newsletter_lightbox() { 
